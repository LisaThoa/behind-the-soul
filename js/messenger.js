      ...
      message: {
                ...
                case "delete":
                  if (confirm(FAM.lang.delete_message)) {
                    ...
                    caller.querySelector(".FAM-msg-content").innerHTML =
                      '<div class="FAM-msg-text"><i class="bi bi-hourglass"></i></div>';
        ...
        parse: function (post, index, nextPost) {
          ...
          return (
            ...
            (!_userdata.session_logged_in && name == FAM.lang.guest)
              ? " FAM-my-msg"
              : "") +
            " " +
      ...
      init: function () {
        ...
        function build() {
          ...
          chat.innerHTML =
            ...
            '<div id="FAM-keyboard"><div id="FAM-menu"><i class="bi bi-arrow-up"></i><i class="bi bi-square-fill"></i><i class="bi bi-arrow-left"></i><i class="bi bi-arrow-right"></i><i class="bi bi-arrow-down"></i></div><div id="FAM-numbers"><i class="bi bi-1-square"></i><i class="bi bi-2-square"></i><i class="bi bi-3-square"></i><i class="bi bi-4-square"></i><i class="bi bi-5-square"></i><i class="bi bi-6-square"></i><i class="bi bi-7-square"></i><i class="bi bi-8-square"></i><i class="bi bi-9-square"></i><i class="bi bi-asterisk"></i><i class="bi bi-0-square"></i><i class="bi bi-hash"></i></div></div>';
